const ModeloInvalidoErro = class ModeloInvalidoErro {
    ...
    constructor(status, mensagem){
        ...
        this.mensage = mensagem || `O modelo informado é inválido`;
...
const NaoAutorizadoErro = class NaoAutorizadoErro {
    ...
    constructor(status, mensagem){
        ...
        this.mensage = mensagem || `Recurso não autorizado`;
...
const NaoEncontradoErro = class NaoEncontradoErro {
    ...
    constructor(status, mensagem){
        ...
        this.mensage = mensagem || `Não encontrado`;
...
const AplicacaoErro = class AplicacaoErro {
    ...
    constructor(status, mensagem){
        ...
        this.mensage = `Erro interno na aplicação ${mensagem && '- ' + mensagem }`;
        this.name = 'Aplicacao';
        this.stack = (new Error()).stack;
    }
}
